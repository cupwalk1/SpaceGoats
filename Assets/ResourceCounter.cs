...
public class ResourceCounter : MonoBehaviour
{
   ...
   void Update()
   {
      ...
      energyText.text = $"{(_resourceManager.TotalEnergy * ResourceManager.Instance.EnergyProducedByEachGenerator).ToString()}/{count*ResourceManager.Instance.EnergyProducedByEachGenerator} kW";
      energySlider.value = (float) _resourceManager.TotalEnergy/count;
      
      plantText.text = _resourceManager.TotalFood.ToString();
